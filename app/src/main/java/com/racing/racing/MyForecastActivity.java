...
public class MyForecastActivity extends AppCompatActivity implements View.OnClickListener, LoadMoreRecyclerView.LoadMoreListener, SwipeRefreshLayout.OnRefreshListener,MyForecastAdapter.OnItemOnClick {
...
//        getData(userBean.getId(), "pk10", currpage);
        //获取当前的期数
...
//                    getData(userBean.getId(), "pk10", 1);
    ...
    public void onItem(int position) {
        //预测详情
        Intent intent_detaile = new Intent();
        intent_detaile.setClass(MyForecastActivity.this,MyYuCeDetailActivity.class);
        intent_detaile.putExtra("id",list_my_forecast.get(position).getId());
        startActivity(intent_detaile);
    }
}
