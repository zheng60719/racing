...
public class FollowActivity extends AppCompatActivity implements View.OnClickListener,FollowAdapter.FollowOnItemClick {
    ...
    public void OnItemClick(int position) {
        Intent intent = new Intent(FollowActivity.this,ZhuanJiaDetailActivity.class);
        intent.putExtra("id", list_fenxi.get(position).getId());
        intent.putExtra("type", 1);
        intent.putExtra("name", list_fenxi.get(position).getList_user().get(0).getNicheng());
        intent.putExtra("fensi", list_fenxi.get(position).getList_user().get(0).getFensi_num());
        intent.putExtra("fanan", list_fenxi.get(position).getList_user().get(0).getZaishou_yuce_num());
        intent.putExtra("ok", list_fenxi.get(position).getList_user().get(0).getYuce_ok_num());
        intent.putExtra("beizhu", list_fenxi.get(position).getList_user().get(0).getBeizhu());
        intent.putExtra("title", list_fenxi.get(position).getTitle());
        intent.putExtra("qishu", list_fenxi.get(position).getQishu_last());
        intent.putExtra("shijian", list_fenxi.get(position).getShijian());
        intent.putExtra("tx", list_fenxi.get(position).getList_user().get(0).getTx());
