...
public class SendPredictionSchemeActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    //大小预测
    private LinearLayout ll_daxiao_yuce, ll_zhihe_yuce;
    //大小
    ...
    //值和
    private TextView tv_zhihe1, tv_zhihe2;
    ...
    //冠亚和预测
    private LinearLayout ll_he_yuce;
    private TextView tv_num1, tv_num2, tv_num3, tv_num4, tv_num5, tv_num6, tv_num7, tv_num8, tv_num9, tv_num10, tv_num11, tv_num12, tv_num13, tv_num14, tv_num15, tv_num16, tv_num17;
    ...
    private void InitView() {
        ...
        //值和
        tv_zhihe1 = (TextView) findViewById(R.id.tv_zhihe1);
        tv_zhihe2 = (TextView) findViewById(R.id.tv_zhihe2);
        ll_zhihe_yuce = (LinearLayout) findViewById(R.id.ll_zhihe_yuce);
        tv_zhihe1.setOnClickListener(this);
        tv_zhihe2.setOnClickListener(this);
        //龙虎
        ...
        //冠亚和系列预测
        ll_he_yuce = (LinearLayout) findViewById(R.id.ll_he_yuce);
        ...
        tv_num10.setOnClickListener(this);
        tv_num11 = (TextView) findViewById(R.id.tv_num11);
        tv_num11.setOnClickListener(this);
        tv_num12 = (TextView) findViewById(R.id.tv_num12);
        tv_num12.setOnClickListener(this);
        tv_num13 = (TextView) findViewById(R.id.tv_num13);
        tv_num13.setOnClickListener(this);
        tv_num14 = (TextView) findViewById(R.id.tv_num14);
        tv_num14.setOnClickListener(this);
        tv_num15 = (TextView) findViewById(R.id.tv_num15);
        tv_num15.setOnClickListener(this);
        tv_num16 = (TextView) findViewById(R.id.tv_num16);
        tv_num16.setOnClickListener(this);
        tv_num17 = (TextView) findViewById(R.id.tv_num17);
        tv_num17.setOnClickListener(this);
    }
        ...
        switch (view.getId()) {
                ...
                if (type == 1) {
                            ...
                            if (yuCeQiShu != null) {
                                if (weizhi1 != -1) {
                                    if (daxiao != null && !daxiao.isEmpty()) {
                                        if (et_money_num.getText().toString().trim() != null && et_money_num.getText().toString().trim().length() > 0) {
                                            SendPredictionSchemeDaXiao(userBean.getId(), et_title.getText().toString().trim(), type + "", numType, yuCeQiShu, weizhi1, daxiao, et_money_num.getText().toString().trim());
                                        } else {
                                            ToastUtil.showToast(SendPredictionSchemeActivity.this, "请你输入查看此预测金币数量");
                                        }
                                    } else {
                            ...
                            if (yuCeQiShu != null) {
                                if (weizhi1 != -1) {
                                    if (danshuang != null && !danshuang.isEmpty()) {
                                        if (et_money_num.getText().toString().trim() != null && et_money_num.getText().toString().trim().length() > 0) {
                                            SendPredictionSchemeDanShuang(userBean.getId(), et_title.getText().toString().trim(), type + "", numType, yuCeQiShu, weizhi1, danshuang, et_money_num.getText().toString().trim());
                                        } else {
                                            ToastUtil.showToast(SendPredictionSchemeActivity.this, "请你输入查看此预测金币数量");
                                        }
                                    } else {
                    ...
                    if (et_title.getText().toString().trim() != null && et_title.getText().toString().length() > 0) {
                        if (numType != -1) {
                            if (yuCeQiShu != null) {
                                if (weizhi1 != -1) {
                                    if (zhihe != null && !zhihe.isEmpty()) {
                                        if (et_money_num.getText().toString().trim() != null && et_money_num.getText().toString().trim().length() > 0) {
                                            SendPredictionZhiHe(userBean.getId(), et_title.getText().toString().trim(), type + "", numType, yuCeQiShu, weizhi1, zhihe, et_money_num.getText().toString().trim());
                                        } else {
                                            ToastUtil.showToast(SendPredictionSchemeActivity.this, "请你输入查看此预测金币数量");
                                        }
                                    } else {
                                        ToastUtil.showToast(SendPredictionSchemeActivity.this, "请你选择预测值和");
                                    }
                                } else {
                                    ToastUtil.showToast(SendPredictionSchemeActivity.this, "请你选择定位号码");
                                }
                            ...
                            if (yuCeQiShu != null) {
                                if (weizhi1 != -1) {
                                    if (longhu != null && !longhu.isEmpty()) {
                                        if (et_money_num.getText().toString().trim() != null && et_money_num.getText().toString().trim().length() > 0) {
                                            SendPredictionLongHu(userBean.getId(), et_title.getText().toString().trim(), type + "", numType, yuCeQiShu, weizhi1, longhu, et_money_num.getText().toString().trim());
                                        } else {
                                            ToastUtil.showToast(SendPredictionSchemeActivity.this, "请你输入查看此预测金币数量");
                                        }
                                    } else {
                        ...
                        if (numType != -1) {
                            if (yuCeQiShu != null) {
                                if (he != null && !he.isEmpty()) {
                                    if (et_money_num.getText().toString().trim() != null && et_money_num.getText().toString().trim().length() > 0) {
                                        SendPredictionSchemeGuanYaHe(userBean.getId(), et_title.getText().toString().trim(), type + "", numType, yuCeQiShu, he, et_money_num.getText().toString().trim());
                                    } else {
                                        ToastUtil.showToast(SendPredictionSchemeActivity.this, "请你输入查看此预测金币数量");
                                    }
                                } else {
            ...
            case R.id.tv_type:
                ...
                if (list_type.size() <= 0) {
                    ...
                    sendNumType3.setNumTypeName("质和系列");
                    list_type.add(sendNumType3);

                    SendNumType sendNumType4 = new SendNumType();
                    sendNumType4.setNumType(5);
                    sendNumType4.setNumTypeName("龙虎系列");
                    list_type.add(sendNumType4);

                    SendNumType sendNumType5 = new SendNumType();
                    sendNumType5.setNumType(6);
                    sendNumType5.setNumTypeName("冠亚和系列");
                    list_type.add(sendNumType5);
                }
                ...
                listViewDialog_type.setOnItemOnclickListener(new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                        ...
                        if (type == 1) {
                            ...
                            ll_he_yuce.setVisibility(View.GONE);
                        } else if (type == 2) {
                            ...
                            ll_daxiao_yuce.setVisibility(View.GONE);
                            ll_zhihe_yuce.setVisibility(View.VISIBLE);
                            ll_number_yuce.setVisibility(View.GONE);
                            ll_dingweihaoma.setVisibility(View.VISIBLE);
                            ll_longhu_weizhi.setVisibility(View.GONE);
                            ll_he_yuce.setVisibility(View.GONE);
                            ...
                            ll_longhu_weizhi.setVisibility(View.VISIBLE);
                            ll_he_yuce.setVisibility(View.GONE);
                        } else if (type == 6) {
                            ll_daxiao_yuce.setVisibility(View.GONE);
                            ll_zhihe_yuce.setVisibility(View.GONE);
                            ll_number_yuce.setVisibility(View.GONE);
                            ll_dingweihaoma.setVisibility(View.GONE);
                            ll_longhu_weizhi.setVisibility(View.GONE);
                            ll_he_yuce.setVisibility(View.VISIBLE);
                        }
            ...
            case R.id.tv_num1:
                he = "03";
                tv_num1.setBackgroundResource(R.drawable.btn_number_type1);
                tv_num1.setTextColor(Color.parseColor("#FF0000"));
                tv_num2.setBackgroundResource(R.drawable.btn_number_type);
                tv_num2.setTextColor(Color.parseColor("#000000"));
                tv_num3.setBackgroundResource(R.drawable.btn_number_type);
                tv_num3.setTextColor(Color.parseColor("#000000"));
                tv_num4.setBackgroundResource(R.drawable.btn_number_type);
                tv_num4.setTextColor(Color.parseColor("#000000"));
                tv_num5.setBackgroundResource(R.drawable.btn_number_type);
                tv_num5.setTextColor(Color.parseColor("#000000"));
                tv_num6.setBackgroundResource(R.drawable.btn_number_type);
                tv_num6.setTextColor(Color.parseColor("#000000"));
                tv_num7.setBackgroundResource(R.drawable.btn_number_type);
                tv_num7.setTextColor(Color.parseColor("#000000"));
                tv_num8.setBackgroundResource(R.drawable.btn_number_type);
                tv_num8.setTextColor(Color.parseColor("#000000"));
                tv_num9.setBackgroundResource(R.drawable.btn_number_type);
                tv_num9.setTextColor(Color.parseColor("#000000"));
                tv_num10.setBackgroundResource(R.drawable.btn_number_type);
                tv_num10.setTextColor(Color.parseColor("#000000"));
                tv_num11.setBackgroundResource(R.drawable.btn_number_type);
                tv_num11.setTextColor(Color.parseColor("#000000"));
                tv_num12.setBackgroundResource(R.drawable.btn_number_type);
                tv_num12.setTextColor(Color.parseColor("#000000"));
                tv_num13.setBackgroundResource(R.drawable.btn_number_type);
                tv_num13.setTextColor(Color.parseColor("#000000"));
                tv_num14.setBackgroundResource(R.drawable.btn_number_type);
                tv_num14.setTextColor(Color.parseColor("#000000"));
                tv_num15.setBackgroundResource(R.drawable.btn_number_type);
                tv_num15.setTextColor(Color.parseColor("#000000"));
                tv_num16.setBackgroundResource(R.drawable.btn_number_type);
                tv_num16.setTextColor(Color.parseColor("#000000"));
                tv_num17.setBackgroundResource(R.drawable.btn_number_type);
                tv_num17.setTextColor(Color.parseColor("#000000"));
                break;
            case R.id.tv_num2:
                he = "04";
                tv_num2.setBackgroundResource(R.drawable.btn_number_type1);
                tv_num2.setTextColor(Color.parseColor("#FF0000"));
                tv_num1.setBackgroundResource(R.drawable.btn_number_type);
                tv_num1.setTextColor(Color.parseColor("#000000"));
                tv_num3.setBackgroundResource(R.drawable.btn_number_type);
                tv_num3.setTextColor(Color.parseColor("#000000"));
                tv_num4.setBackgroundResource(R.drawable.btn_number_type);
                tv_num4.setTextColor(Color.parseColor("#000000"));
            ...
            case R.id.tv_num3:
                he = "05";
                tv_num3.setBackgroundResource(R.drawable.btn_number_type1);
            ...
            case R.id.tv_num4:
                he = "06";
                tv_num4.setBackgroundResource(R.drawable.btn_number_type1);
            ...
            case R.id.tv_num5:
                he = "07";
                tv_num5.setBackgroundResource(R.drawable.btn_number_type1);
                tv_num5.setTextColor(Color.parseColor("#FF0000"));
                tv_num2.setBackgroundResource(R.drawable.btn_number_type);
                tv_num2.setTextColor(Color.parseColor("#000000"));
                tv_num3.setBackgroundResource(R.drawable.btn_number_type);
                tv_num3.setTextColor(Color.parseColor("#000000"));
            ...
            case R.id.tv_num6:
                he = "08";
                tv_num6.setBackgroundResource(R.drawable.btn_number_type1);
                tv_num6.setTextColor(Color.parseColor("#FF0000"));
                tv_num2.setBackgroundResource(R.drawable.btn_number_type);
                tv_num2.setTextColor(Color.parseColor("#000000"));
                tv_num3.setBackgroundResource(R.drawable.btn_number_type);
                tv_num3.setTextColor(Color.parseColor("#000000"));
            ...
            case R.id.tv_num7:
                he = "09";
                tv_num7.setBackgroundResource(R.drawable.btn_number_type1);
                tv_num7.setTextColor(Color.parseColor("#FF0000"));
                tv_num2.setBackgroundResource(R.drawable.btn_number_type);
                tv_num2.setTextColor(Color.parseColor("#000000"));
                tv_num3.setBackgroundResource(R.drawable.btn_number_type);
                tv_num3.setTextColor(Color.parseColor("#000000"));
            ...
            case R.id.tv_num8:
                he = "10";
                tv_num8.setBackgroundResource(R.drawable.btn_number_type1);
                tv_num8.setTextColor(Color.parseColor("#FF0000"));
                tv_num2.setBackgroundResource(R.drawable.btn_number_type);
                tv_num2.setTextColor(Color.parseColor("#000000"));
                tv_num3.setBackgroundResource(R.drawable.btn_number_type);
                tv_num3.setTextColor(Color.parseColor("#000000"));
            ...
            case R.id.tv_num9:
                he = "11";
                tv_num9.setBackgroundResource(R.drawable.btn_number_type1);
                tv_num9.setTextColor(Color.parseColor("#FF0000"));
                tv_num2.setBackgroundResource(R.drawable.btn_number_type);
                tv_num2.setTextColor(Color.parseColor("#000000"));
                tv_num3.setBackgroundResource(R.drawable.btn_number_type);
                tv_num3.setTextColor(Color.parseColor("#000000"));
            ...
            case R.id.tv_num10:
                he = "12";
                tv_num10.setBackgroundResource(R.drawable.btn_number_type1);
                tv_num10.setTextColor(Color.parseColor("#FF0000"));
                tv_num2.setBackgroundResource(R.drawable.btn_number_type);
                tv_num2.setTextColor(Color.parseColor("#000000"));
                tv_num3.setBackgroundResource(R.drawable.btn_number_type);
                tv_num3.setTextColor(Color.parseColor("#000000"));
            ...
            case R.id.tv_num11:
                he = "13";
                tv_num11.setBackgroundResource(R.drawable.btn_number_type1);
                tv_num11.setTextColor(Color.parseColor("#FF0000"));
                tv_num2.setBackgroundResource(R.drawable.btn_number_type);
                tv_num2.setTextColor(Color.parseColor("#000000"));
                tv_num3.setBackgroundResource(R.drawable.btn_number_type);
                tv_num3.setTextColor(Color.parseColor("#000000"));
            ...
            case R.id.tv_num12:
                he = "14";
                tv_num12.setBackgroundResource(R.drawable.btn_number_type1);
                tv_num12.setTextColor(Color.parseColor("#FF0000"));
                tv_num2.setBackgroundResource(R.drawable.btn_number_type);
                tv_num2.setTextColor(Color.parseColor("#000000"));
                tv_num3.setBackgroundResource(R.drawable.btn_number_type);
                tv_num3.setTextColor(Color.parseColor("#000000"));
            ...
            case R.id.tv_num13:
                he = "15";
                tv_num13.setBackgroundResource(R.drawable.btn_number_type1);
                tv_num13.setTextColor(Color.parseColor("#FF0000"));
                tv_num2.setBackgroundResource(R.drawable.btn_number_type);
                tv_num2.setTextColor(Color.parseColor("#000000"));
                tv_num3.setBackgroundResource(R.drawable.btn_number_type);
                tv_num3.setTextColor(Color.parseColor("#000000"));
            ...
            case R.id.tv_num14:
                he = "16";
                tv_num14.setBackgroundResource(R.drawable.btn_number_type1);
                tv_num14.setTextColor(Color.parseColor("#FF0000"));
                tv_num2.setBackgroundResource(R.drawable.btn_number_type);
                tv_num2.setTextColor(Color.parseColor("#000000"));
                tv_num3.setBackgroundResource(R.drawable.btn_number_type);
                tv_num3.setTextColor(Color.parseColor("#000000"));
            ...
            case R.id.tv_num15:
                he = "17";
                tv_num15.setBackgroundResource(R.drawable.btn_number_type1);
                tv_num15.setTextColor(Color.parseColor("#FF0000"));
                tv_num2.setBackgroundResource(R.drawable.btn_number_type);
                tv_num2.setTextColor(Color.parseColor("#000000"));
                tv_num3.setBackgroundResource(R.drawable.btn_number_type);
                tv_num3.setTextColor(Color.parseColor("#000000"));
            ...
            case R.id.tv_num16:
                he = "18";
                tv_num16.setBackgroundResource(R.drawable.btn_number_type1);
                tv_num16.setTextColor(Color.parseColor("#FF0000"));
                tv_num2.setBackgroundResource(R.drawable.btn_number_type);
                tv_num2.setTextColor(Color.parseColor("#000000"));
                tv_num3.setBackgroundResource(R.drawable.btn_number_type);
                tv_num3.setTextColor(Color.parseColor("#000000"));
            ...
            case R.id.tv_num17:
                he = "19";
                tv_num17.setBackgroundResource(R.drawable.btn_number_type1);
                tv_num17.setTextColor(Color.parseColor("#FF0000"));
                tv_num2.setBackgroundResource(R.drawable.btn_number_type);
                tv_num2.setTextColor(Color.parseColor("#000000"));
                tv_num3.setBackgroundResource(R.drawable.btn_number_type);
                tv_num3.setTextColor(Color.parseColor("#000000"));
            ...
            case R.id.tv_zhihe1:
                zhihe = "质";
                tv_zhihe1.setBackgroundResource(R.drawable.btn_number_type1);
                tv_zhihe1.setTextColor(Color.parseColor("#FF0000"));
                tv_zhihe2.setBackgroundResource(R.drawable.btn_number_type);
                tv_zhihe2.setTextColor(Color.parseColor("#000000"));
                break;
            case R.id.tv_zhihe2:
                zhihe = "和";
                tv_zhihe2.setBackgroundResource(R.drawable.btn_number_type1);
                tv_zhihe2.setTextColor(Color.parseColor("#FF0000"));
                tv_zhihe1.setBackgroundResource(R.drawable.btn_number_type);
                tv_zhihe1.setTextColor(Color.parseColor("#000000"));
                break;
    ...
    public void SendPredictionScheme(int uid, String title, String type, int numtype, String qishu_date, int weizhi, String num, String money) {
        OkHttpUtils
                .post()
                .url("http://www.zse6.com/index.php/mobile/ajax/fa_yuce_pk10")
                .addParams("uid", uid + "")
    ...
    //预测值和
    public void SendPredictionZhiHe(int uid, String title, String type, int numtype, String qishu_date, int weizhi, String zhihe, String money) {
        OkHttpUtils
                .post()
                .url("http://www.zse6.com/index.php/mobile/ajax/fa_yuce_pk10")
                .addParams("uid", uid + "")
    ...
    //预测冠亚和
    public void SendPredictionSchemeGuanYaHe(int uid, String title, String type, int numtype, String qishu_date, String guanyanum, String money) {
        OkHttpUtils
                .post()
                .url("http://www.zse6.com/index.php/mobile/ajax/fa_yuce_pk10")
                .addParams("uid", uid + "")
