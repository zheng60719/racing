...
/**
 * Created by k41 on 2017/10/10.
 */

public class ErJi extends BaseEntity {
    private int id;
    ...
    private String daxiaoing;
    private String num6;
    private String num7;
    private String num8;
    private String num9;
    private String num10;
    private String danshuanging;

    public String getDanshuanging() {
        return danshuanging;
    }

    public void setDanshuanging(String danshuanging) {
        this.danshuanging = danshuanging;
    }
    ...
    public void setNuming(String numing) {
        this.numing = numing;
    }
    ...
    public String getDaxiaoing() {
        return daxiaoing;
    }

    public void setDaxiaoing(String daxiaoing) {
        this.daxiaoing = daxiaoing;
    }
