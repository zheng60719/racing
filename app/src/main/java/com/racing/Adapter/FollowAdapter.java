...
public class FollowAdapter extends CommonRecyclerAdapter<FenXi> {
    private Context mContext;
    private List<FenXi> dataList;
    private FollowOnItemClick followOnItemClick;

    public FollowAdapter(Context mContext, List<FenXi> dataList, int resId) {
        super(mContext, dataList, resId);
        this.mContext = mContext;
        this.dataList = dataList;
        this.followOnItemClick = (FollowOnItemClick) mContext;
    }
    ...
    public void setData(RecyclerViewHolder holder, final int position) {
        ...
        try {
            Glide.with(mContext).load(fenXi.getList_user().get(0).getTx()).centerCrop().placeholder(R.color.white)
        ...
        holder.setOnClickListener(R.id.onItem, new View.OnClickListener() {
            ...
            public void onClick(View view) {
                followOnItemClick.OnItemClick(position);
            }
        });
    }
    public interface FollowOnItemClick{
