...
public class ForecastAdapter extends CommonRecyclerAdapter<LiShi> {
    private Context mContext;
    private List<LiShi> dataList;
    private String qishu;
    private ForecastOnItemClick forecastOnItemClick;

    public ForecastAdapter(Context mContext, List<LiShi> dataList, int resId, String qishu) {
    ...
    public void setData(RecyclerViewHolder holder, final int position) {
        ...
        onItem.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                forecastOnItemClick.onItemClick(position);
            }
        });
    }
