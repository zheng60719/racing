...
import static com.racing.R.style.item;

/**
 * Created by Administrator on 2017/1/4.
 */
public class MyDaxiaoAdapter extends BaseAdapter{
    public Context context;
    public List<List<String>> list_daxiao;
    public MyDaxiaoAdapter(Context context,List<List<String>> list_daxiao){
